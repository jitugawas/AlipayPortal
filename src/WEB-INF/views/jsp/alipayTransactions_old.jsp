								...
								<div class="col-lg-12 col-md-12">
									...
									<div class="row">
										<c:if test="${sessionScope.role_id == 1}">
											<div class="col-lg-3 col-md-8 col-sm-12">
												<lable class="calender_lable">User ID</lable>
												<select class="calender_select select_width" id="user_id">
													<option value="">All</option>
													<c:choose>
														<c:when test="${Users.size() > 0 }">
															<c:forEach items="${Users}" var="each">
																<option value="${each.value.user_id}">${each.value.user_id}</option>
															</c:forEach>
														</c:when>
													</c:choose>
															...
															<c:when test="${transList.size() > 0 }">
																<c:forEach items="${transList }" var="each">
																	<tr>
																		...
																		<td><a
																			href="<%= DynamicPaymentConstant.SERVER_HOST+DynamicPaymentConstant.SITE_URL+"/getTransactionDetailsById" %>?id=${each.value.id }"
																			target="_blank">${each.value.pgPartnerTransId }</a></td>
									...
									<div class="row buttons">
										<div class="col-md-12 col-sm-12 col-xs-12">
											<a href="downloadReportPDF"><div class="btn btn-primary">Download
													PDF</div></a> <a href="downloadReportCSV"><div
													class="btn btn-primary">Download CSV</div></a>
										</div>
									</div>
							...
							<div class="row">
								<div class="col-lg-12 col-md-11">
									...
									<div class="row">
										...
										<div class="col-lg-4 col-md-6">
											<input type="text" class="inp" placeholder="Date/Time"
												id="dateAndtime">
										</div>
									</div>
									<div class="row">
										<div class="col-lg-2  col-md-4 control_label">Transaction
											ID</div>
										<div class="col-lg-4 col-md-6">
											<input type="email" class="inp" placeholder="Transaction ID"
												id="transaction_id">
										</div>
									</div>
									<div class="row">
										...
										<div class="col-lg-4 col-md-6">
											<input type="text" class="inp" placeholder="Status"
												id="status">
										</div>
									</div>
									<div class="row">
										...
										<div class="col-lg-4 col-md-6">
											<input type="text" class="inp" placeholder="Channel"
												id="chan">
										</div>
									</div>
									<div class="row">
										...
										<div class="col-lg-4 col-md-6">
											<input type="text" class="inp" placeholder="Reference"
												id="ref">
										</div>
									</div>
									...
									<div class="row">
										...
										<div class="col-lg-4 col-md-6">
											<input type="text" class="inp" placeholder="Comments"
												id="comments">
										</div>
									</div>
									<div class="row">
									...
									<div class="row">
										...
										<div class="col-lg-4 col-md-6">
											<input type="text" class="inp" placeholder="Mobile"
												id="mobile">
										</div>
									</div>
									<div class="row">
										...
										<div class="col-lg-4 col-md-6">
											<input type="text" class="inp" placeholder="Coordinates"
												id="coordinates">
										</div>
									</div>
									<!-- <div class="row">
               ...
               <input type="text" class="inp" placeholder="Transaction Fee" id="trans_fee">
							...
							<div class="row buttons">
								<div class="col-md-5 col-md-offset-2 col-sm-12 col-xs-12">
									...
									<button type="submit" id="btnrefund" class="btn btn-primary">Refund</button>
