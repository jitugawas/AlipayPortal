				...
				<div class="col-md-12">
					<div class="right_first_box">
						<a href="#"><img src="resources/core/images/home.png"></a><a
							href="setupMerchant">Setup Merchant</a> / &nbsp;<span class="breadscrum_active">Edit Merchant </span>
					</div>
				</div>
			</div>
			<div class="row"
				...
				<div class="col-lg-7 col-md-12">
					...
					<h4 class="heading">Edit Merchant Details</h4>
					...
					<div class="row">
						...
						<div class="col-md-8">
							<form:input type="text"
								class="inp validate[required,custom[email]]" placeholder="Email" path="email" disabled="true" readonly="true"/>
					...
					<div class="row">
						...
						<div class="col-md-8">
							<form:input type="text"
								class="inp validate[required]" placeholder="account id" path="infidigiAccountId" disabled="true" readonly="true"/>
...
var	validationStatus = 1;
			...
			.ready(
					function() {
						...
						$('#cancelBtn').click(function() {
							window.location.href = "setupMerchant";
						});
												...
												$('#fileTable')
														.append(
																'<tr>'
																		...
																		+ '<td><input type="file" name="files['+ fileIndex +']" class="div_float" id="files['+ fileIndex +']" onchange="fileSizeValidation(this,files['+ fileIndex+']);"><input type="button"  class="btn btn-primary save_btn" value="Delete" onclick="deleteRow(this)"></td>'
																		+ '</tr>');
											}
										});
	...
	function deleteFile(id,userId)
	{
		alertify.confirm("Are you sure you want to delete this file?", function (e) { if (e) {
	        // user clicked "ok"
			window.location.href="deleteMerchantFile?id="+id+"&userId="+userId;
	    } else {
	        // user clicked "cancel"
	  		return false;
	    }
