...
<div id="page-wrapper">
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-12">
				<div class="right_first_box">
					...
					<a href="setupMerchant">Setup Merchant</a> / &nbsp;<span class="breadscrum_active">View Merchant Details</span>
				</div>
			</div>
		</div>
		<br class="clear">
		<div class="row" style="background:#fff;margin-right:0px;margin-left:0px;">
			...
			<a href="setupMerchant"><div class="btn btn-primary save_btn" style="margin-top:10px;">Return to Merchant Listing</div></a>
			<h4 class="heading">Merchant Details</h4>
		...
		<div class="row" style="background:#fff;margin-right:0px;margin-left:0px;">
			<div class="col-lg-6 col-md-6">
			<h4 class="heading">Merchant Files Details</h4>
			<div class="table-responsive">
				<table class="table table-bordered textarea_marginbottom">
				<thead>
				<tr>
