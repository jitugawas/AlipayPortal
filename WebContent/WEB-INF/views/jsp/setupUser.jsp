...
<div id="page-wrapper">
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-12">
   				 <div class="right_first_box"><a href="#"><img src="resources/core/images/home.png" ></a> / &nbsp;<span class="breadscrum_active">Setup Users</span></div>
             </div>
		</div>
		<br class="clear">
		<div class="row">
			<div class="col-md-12">
				<ul class="nav nav-tabs responsive-tabs">
					...
					<li><a href="#Create" id="create1" onclick="generateID();">Create
							User </a></li>
				</ul>
				...
				<div class="tab-pane active" id="Users">
					<form method='POST' id="search_user_form">
						...
						<div class="row">
							...
							<a href="downloadUserCSV"><div class="btn btn-primary save_btn">Download CSV</div></a>
							</div>
							<div class="col-md-2 col-sm-5 col-xs-6">
							<a href="downloadUserPDF"><div class="btn btn-primary save_btn">Download PDF</div></a>
							</div>
						</div>
					</div>
					<!--Tab div end-->
						...
						<form:form action="registerUser" commandName='userForm'
							...
							<div class="row">
								<div class="col-lg-7 col-md-12">
									<div class="row">
										...
										<div class="col-md-8">
											...
											<form:input type="text"
												class="readonly_background inp validate[required,custom[onlyLetterNumberSpaceTempSubj]]"
									...
									<form:input type="hidden" class="inp" placeholder="id"
										path="id" />
	...
	$(document).ready(
			function() {
				...
				$(".btn_reset").click(function() {
					...
					$.ajax({
						type : "POST",
						url :"<%= "/"+DynamicPaymentConstant.SITE_URL +"/getUsersTableAjax" %>",
						dataType : "html",
