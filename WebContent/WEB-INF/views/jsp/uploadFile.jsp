...
<div id="page-wrapper">
     <div class="container-fluid">
         <div class="row">
            <div class="col-md-12">
			<div class="right_first_box"><a href="#"><img src="<%=DynamicPaymentConstant.SITE_BASE_URL %>/resources/core/images/home.png" ></a> / &nbsp;<a href="<%=DynamicPaymentConstant.SITE_BASE_URL %>/reconcil">Reconcilation</a> &nbsp;/ &nbsp;<span  class="breadscrum_active">Upload New File</span></div>
            </div>
          </div>
         
          <h3 class="main_heading">Reconcilation</h3>
          <form method="POST" name="uploadForm" id="uploadForm" action="saveFile" enctype="multipart/form-data">
           <div class="row">
		       <div class="col-md-12">
		         <h4>Please select file to upload</h4><br>
		         <input type="file" name="reconcillationFile" id="reconcillationFile"/><br><br>
		         ...
		         <input type="hidden" name="upload_type" id="upload_type" value= "file"/>
		          <div class="btn btn-primary" id="uploadfile">Upload & Reconcile</div>&nbsp;  
		           <div class="btn btn-primary" id="uploadFtpfile">FTP Upload & Reconcile</div> 
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#uploadfile").click(function() {
			...
			if( document.getElementById("reconcillationFile").files.length > 0){
				selected = true;
			}
			
			var fileName = $("#reconcillationFile").val();
			if(fileName == ""){
				
				alert("Please select file to uplaod!");
				$("#reconcillationFile").focus();
				return false;
				
			}		
			
			var flag = ValidateSingleInput(document.getElementById("reconcillationFile"));
